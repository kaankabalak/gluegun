...
$(document).ready(function () {
    ...
    // Add active class to the sidebar item that was clicked
    $(".doc-link__items > li > a[href='" + window.location.pathname + "'")
        .addClass('doc-link__active'); 
    // Add toggled class to the category of the item that was clicked
    $(".doc-link__items > li > a[href='" + window.location.pathname + "'")
        .parents(".doc-link__category")
        .addClass("toggled"); 
    // Display other items of the same category
    $(".doc-link__items > li > a[href='" + window.location.pathname + "'")
        .parents(".doc-link__items")
        .css("display", "block"); 
